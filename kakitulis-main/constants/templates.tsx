...
export const TEMPLATES: Template[] = [
    {
        ...
        "title": "Shopee Product Description (paragraph)",
        "description": "Create compelling product descriptions for Shopee listings.",
        "command": "Create compelling product descriptions for Shopee listings.",
        "icon": `<i class="fab fa-shopping-cart text-primary"></i>`,
    ...
    },
    {
        ...
        "title": "Shopee Product Features (bullets)",
        "description": "Create key feature and benefit bullet points for Shopee listings under the 'about this item' section.",
        "command": "Create key feature and benefit bullet points for Shopee listings under the 'about this item' section.",
        "icon": `<i class="fab fa-shopping-cart text-primary"></i>`,
        "categories": ["ecommerce", "ads"],
        "inputs": [
            {
    ...
    },
    {
        ...
        "title": "Commands",
        "description": "Tell Alfred exactly what to write with a command.",
        ...
        "inputs": [
            {
                ...
                "type": "textarea",
                "label": "Your command",
                "placeholder": "Write an alternative version about 'Strangers on a Train' in Kanye West's tone of voice",
            },
            {
                "id": "form-field-content",
                "type": "textarea",
                "label": "Background information",
                "placeholder": "Guy and Bruno accidentally targetted the wrong people",
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "inputs": [
            ...
            },
            {
                ...
                "placeholder": "InnovateTech is a cutting-edge technology firm that specializes in developing software solutions for businesses. Founded in 2018 and based in Kuala Lumpur, we focus on helping companies streamline their processes and improve customer engagement.",
            },
            {
                "id": "tone",
                "type": "text",

            ...
            >
                ...
                <div className="w-60 flex flex-col items-center justify-center p-4 hover:cursor-pointer"
                    ...
                    <div className="flex flex-col">
                        <Image src="/images/alfred.ai.png" alt="alfred.ai" width="250" height="100"/>
                        <h1 className="text-lg font-normal text-gray-700 text-center">Your </h1>
                        <h1 className="text-lg font-semibold text-gray-700  text-center">AI <i
                            className="fas fa-arrow-right text-primary"/> Copywriter</h1>
                        ...
                        <li className="mb-10">
                            <div className="flex flex-row align-middle justify-center">
                                <a
                                    ...
                                    href="https://www.linkedin.com/in/nafisnazri/"
                                    target="_blank"

    ...
    return (
        <div
            ...
            <div className="w-11/12 md:w-1/3 p-2 md:p-8 z-10 relative bg-white">
                ...
                <h1 className="text-black text-3xl md:text-4xl text-center font-bold mb-0">Its All Free</h1>
                <div className="w-5/6 md:w-3/4 mx-auto my-4 text-justify">
                    <p className="mb-2"> If you're a fan of Alfred, feel free to show your support by buying me a
                        coffee. </p>
                    <p>
                        {' '}
                    ...
                    <div className="mt-10 flex justify-center justify-items-center">
                        <a href='https://ko-fi.com/nafisnazri' target='_blank'>
                            <img height='36'
